...
exports.hatemile.implementation.AccessibleDisplayScreenReaderImplementation = (function() {
	...
	function AccessibleDisplayScreenReaderImplementation(parser, configure, userAgent) {
		...
		this.attributeHrefPrefixBefore = configure.getParameter('attribute-href-prefix-before');
		this.attributeHrefSuffixBefore = configure.getParameter('attribute-href-suffix-before');
		this.attributeHrefPrefixAfter = configure.getParameter('attribute-href-prefix-after');
		this.attributeHrefSuffixAfter = configure.getParameter('attribute-href-suffix-after');
		...
		this.dataInvalidUrlBefore = configure.getParameter('data-invalid-url-before');
		this.dataInvalidUrlAfter = configure.getParameter('data-invalid-url-after');
		this.dataInvalidEmailBefore = configure.getParameter('data-invalid-email-before');
		this.dataInvalidEmailAfter = configure.getParameter('data-invalid-email-after');
		this.dataInvalidRangeBefore = configure.getParameter('data-invalid-range-before');
		this.dataInvalidRangeAfter = configure.getParameter('data-invalid-range-after');
		this.dataInvalidLengthBefore = configure.getParameter('data-invalid-length-before');
		this.dataInvalidLengthAfter = configure.getParameter('data-invalid-length-after');
		this.dataInvalidPatternBefore = configure.getParameter('data-invalid-pattern-before');
		this.dataInvalidPatternAfter = configure.getParameter('data-invalid-pattern-after');
		this.dataInvalidRequiredBefore = configure.getParameter('data-invalid-required-before');
		this.dataInvalidRequiredAfter = configure.getParameter('data-invalid-required-after');
		this.dataInvalidDateBefore = configure.getParameter('data-invalid-date-before');
		this.dataInvalidDateAfter = configure.getParameter('data-invalid-date-after');
		this.dataInvalidTimeBefore = configure.getParameter('data-invalid-time-before');
		this.dataInvalidTimeAfter = configure.getParameter('data-invalid-time-after');
		this.dataInvalidDateTimeBefore = configure.getParameter('data-invalid-datetime-before');
		this.dataInvalidDateTimeAfter = configure.getParameter('data-invalid-datetime-after');
		this.dataInvalidMonthBefore = configure.getParameter('data-invalid-month-before');
		this.dataInvalidMonthAfter = configure.getParameter('data-invalid-month-after');
		this.dataInvalidWeekBefore = configure.getParameter('data-invalid-week-before');
		this.dataInvalidWeekAfter = configure.getParameter('data-invalid-week-after');
		this.roles = {
		...
		if (element.hasAttribute('accesskey')) {
			...
			if (!isEmpty(this.listShortcuts)) {
				...
				for (_i = 0, _len = keys.length; _i < _len; _i++) {
					key = keys[_i];
					key = key.toUpperCase();
					if (isEmpty(this.parser.find(this.listShortcuts).findChildren("[" + DATA_ATTRIBUTE_ACCESSKEY_BEFORE_OF + "=\"" + key + "\"]").firstResult())) {
	...
	AccessibleDisplayScreenReaderImplementation.prototype.displayLinkAttributes = function(link) {
		...
		if ((link.hasAttribute('href')) && (!isEmpty(link.getAttribute('href')))) {
			forceRead(link, link.getAttribute('href'), this.parser, this.prefixId, this.attributeHrefPrefixBefore, this.attributeHrefSuffixBefore, this.attributeHrefPrefixAfter, this.attributeHrefSuffixAfter, DATA_ATTRIBUTE_HREF_BEFORE_OF, DATA_ATTRIBUTE_HREF_AFTER_OF);
		}
	};
